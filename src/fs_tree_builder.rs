...
/// Build a [`DataTree`] from a directory tree on the real filesystem.
///
/// **Example:**
///
/// ```no_run
...
/// };
/// let data_tree: DataTree<OsStringDisplay, Bytes> = build_data_tree_from_fs()
...
/// ```
#[builder]
pub fn build_data_tree_from_fs<'a, Size, SizeGetter, HardlinksRecorder, Report>(
    /// Root of the directory tree.
    root: PathBuf,
    /// Returns size of an item.
    size_getter: SizeGetter,
    /// Handle to detect and record hardlinks.
    hardlinks_recorder: &'a HardlinksRecorder,
...
{
    build_data_tree::<PathBuf, OsStringDisplay, Size, _, _>()
