...
The benchmark was generated by [a GitHub Workflow](https://github.com/KSXGitHub/parallel-disk-usage/blob/0.12.0/.github/workflows/deploy.yaml#L431-L601) and uploaded to the release page.
...
<figure>
  <img src="https://ksxgithub.github.io/parallel-disk-usage-0.12.0-benchmarks/tmp.benchmark-report.competing.block-size.svg">
...
[_(See more)_](https://github.com/KSXGitHub/parallel-disk-usage-0.12.0-benchmarks/blob/master/tmp.benchmark-report.CHARTS.md)
...
* Unbiased regarding hardlinks: All hardlinks are treated as real files.
